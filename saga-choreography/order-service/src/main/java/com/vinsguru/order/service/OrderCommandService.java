...
public class OrderCommandService {
    ...
    public PurchaseOrder createOrder(OrderRequestDto orderRequestDTO){
        PurchaseOrder purchaseOrder = this.purchaseOrderRepository
                .save(this.dtoToEntity(orderRequestDTO));
        this.publisher.createOrderEvent(purchaseOrder, OrderStatus.ORDER_CREATED);
